package com.yuanting.nomisdun.main.product.content.left;

import android.support.v7.widget.AppCompatTextView;
import android.view.View;

import com.yuanting.nomisdun.R;
import com.yuanting.nomisdun.main.product.content.right.ProductRightItemFields;
import com.yuanting.nomisdun.main.product.content.right.ProductRightItemType;
...
public class ProductLeftAdapter extends MultipleRecyclerAdapter {
    ...
    public ProductLeftAdapter(List<MultipleItemEntity> data) {
        super(data);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_MODEL_ITEM, R.layout.item_nomisdun_product_content_left);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_YEAR_ITEM, R.layout.item_nomisdun_product_content_left);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_SUB_MODEL_ITEM, R.layout.item_nomisdun_product_content_left);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_SERIES_ITEM, R.layout.item_nomisdun_product_content_left);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_END_ITEM, R.layout.item_nomisdun_product_content_left);
    }
