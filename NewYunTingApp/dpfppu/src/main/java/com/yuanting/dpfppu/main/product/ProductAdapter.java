...
public class ProductAdapter extends MultipleRecyclerAdapter {
    ...
    protected ProductAdapter(List<MultipleItemEntity> data) {
        super(data);
        addItemType(ProductItemType.PRODUCT_ITEM, R.layout.item_product_dpf);
    }
                    ...
                    switch (i) {
                        case 0:
                            ...
                            Glide.with(mContext)
                                    ...
                                    .into(imageView1);
                            imageView1.setBackgroundResource(R.drawable.image_edit_circle);
                            break;
                        case 1:
                            ...
                            Glide.with(mContext)
                                    ...
                                    .apply(RECYCLER_OPTIONS)
                                    .into(imageView2);
                            imageView2.setBackgroundResource(R.drawable.image_edit_circle);
                            break;
                        case 2:
                            ...
                            Glide.with(mContext)
                                    ...
                                    .apply(RECYCLER_OPTIONS)
                                    .into(imageView3);
                            imageView3.setBackgroundResource(R.drawable.image_edit_circle);
                            break;
                        case 3:
                            ...
                            Glide.with(mContext)
                                    ...
                                    .apply(RECYCLER_OPTIONS)
                                    .into(imageView4);
                            imageView4.setBackgroundResource(R.drawable.image_edit_circle);
                            break;
                        default:
                            break;
                    }
