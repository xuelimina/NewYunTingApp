package com.yuanting.dpfppu.main.product.content.left;
...
import com.yuanting.dpfppu.main.product.content.right.ProductRightItemType;
...
public class ProductLeftAdapter extends MultipleRecyclerAdapter {
    ...
    public ProductLeftAdapter(List<MultipleItemEntity> data) {
        super(data);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_MODEL_ITEM, R.layout.item_product_content_left_dpf);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_YEAR_ITEM, R.layout.item_product_content_left_dpf);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_SUB_MODEL_ITEM, R.layout.item_product_content_left_dpf);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_SERIES_ITEM, R.layout.item_product_content_left_dpf);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_END_ITEM, R.layout.item_product_content_left_dpf);
    }
