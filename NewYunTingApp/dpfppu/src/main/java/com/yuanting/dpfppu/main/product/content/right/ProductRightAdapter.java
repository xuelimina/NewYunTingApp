package com.yuanting.dpfppu.main.product.content.right;
...
public class ProductRightAdapter extends MultipleRecyclerAdapter {
    ...
    public ProductRightAdapter(List<MultipleItemEntity> data) {
        super(data);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_MODEL_ITEM, R.layout.item_product_content_right_dpf);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_YEAR_ITEM, R.layout.item_product_content_right_dpf);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_SUB_MODEL_ITEM, R.layout.item_product_content_right_dpf);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_SERIES_ITEM, R.layout.item_product_content_right_dpf);
        addItemType(ProductRightItemType.PRODUCT_RIGHT_END_ITEM, R.layout.item_product_content_right_dpf);
    }
